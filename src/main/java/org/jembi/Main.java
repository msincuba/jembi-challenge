...
public class Main {
    ...
    public static void main(String[] args) throws IOException, SQLException {
        ...
        statement.executeUpdate("create table if not exists patients (id primary key, identityNumber string, " +
            ...
            if (duplicates.isBeforeFirst()) {
                while (duplicates.next()) {
                    if (fields[0] == duplicates.getString("identityNumber")) {
                        continue;
                    } else if (fields[1] == duplicates.getString("firstName") && fields[2] == duplicates.getString("lastName")) {
                        if (fields[5] == duplicates.getString("gender") && fields[6] == duplicates.getString("race")) {
                            continue;
                        }
                    } else {
